...
public interface CalcModel {
	...
	/**
	 * Postavljanje zamrznute vrijednosti.
	 * 
	 * @param value zamrnuta vrijednost
	 */
	void freezeValue(String value);
	
	/**
	 * Postoji li zamrznuta vrijednost.
	 * 
	 * @return true ako je zamrznuta vrijednost različita od <code>null</code>
	 */
