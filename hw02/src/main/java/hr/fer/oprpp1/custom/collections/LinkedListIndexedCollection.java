...
/**
 * Instances of this class implements {@link List} and represents a linked list-backed collection of Objects.
...
public class LinkedListIndexedCollection implements List {
	...
	private static class ListElementsGetter implements ElementsGetter {
		...
		private LinkedListIndexedCollection.ListNode currentNode;
		 ...
		 */
		public ListElementsGetter(LinkedListIndexedCollection linkedListCollection) {
			super();
	...
	public ElementsGetter createElementsGetter() {
		ElementsGetter eg = new ListElementsGetter(this);
